<?php
/*
Template Name: tag-u13ページ
*/
get_header(); ?>
    <!-- //＠＠＠＠＠＠＠＠＠＠＠＠＠＠＠＠＠＠ -->
    <!-- //contactタイトル-->
    <!-- //＠＠＠＠＠＠＠＠＠＠＠＠＠＠＠＠＠＠ -->
    <main class="tag-u13bg">
        <!-- パンくずリスト -->
        ...
        <div class="cmn-article-wrapper tag-inner">
          <section class="cmn-news-list tag-news-list-u13">
            ...
            <h2 class="cmn-page-head u13-page-head">
              U-13 大会<span class="cmn-page-head-subttl"
                >九州クラブユースU-13大会　大会情報</span
              >
            </h2>
            <div class="cmn-news-list-container">
              ...
              <ul class="cmn-news-list is-pc">
                  ...
                  <a href="#">
                    <div class="cmn-news-article">
                      <div class="cmn-news-cat-wrapper">
                        <div class="cmn-news-cat-info info-cat-u13">
                          お知らせ
                        </div>
                      </div>
                ...
                <li class="cmn-news-item">
                  <a href="#">
                    <div class="cmn-news-article">
                      <div class="cmn-news-cat-wrapper">
                        <div class="cmn-news-cat-info info-cat-u18tcc">
                          加盟登録
                        </div>
                      </div>
                      <div class="cmn-news-post">
                ...
                <li class="cmn-news-item">
                  <a href="#">
                    <div class="cmn-news-article">
                      <div class="cmn-news-cat-wrapper">
                        <span class="cmn-news-cat-info info-cat-u18tcc"
                          >U-13</span
                        >
                      </div>
                      <div class="cmn-news-post">
              ...
              <ul class="cmn-news-list is-sp">
                ...
                <li class="cmn-news-item">
                  <a href="#">
                    <div class="cmn-news-article">
                      <div class="sp-cmn-news-top">
                        <div class="cmn-news-cat-info info-cat-u18confirm">
                          お知らせ
                        </div>
                        <div class="cmn-news-date">2020/4/15</div>
                      </div>
              ...
              <ul class="Pagination">
                <li class="Pagination-Item">
                  <a class="Pagination-Item-Link" href="/pages/1/"> ← </a>
                </li>
                <li class="Pagination-Item">
                ...
                <li class="Pagination-Item">
                  <a class="Pagination-Item-Link" href="/pages/5/"> → </a>
                </li>
              </ul>
            </div>
          </section>
