          ...
          <ul class="cmn-news-list is-pc">
              ...
              <a href="#">
                <div class="cmn-news-article">
                  <div class="cmn-news-cat-wrapper">
                    <div class="cmn-news-cat-info info-cat-training">お知らせ</div>
                  </div>
            ...
            <li class="cmn-news-item">
              <a href="#">
                <div class="cmn-news-article">
                  <div class="cmn-news-cat-wrapper">
                    <div class="cmn-news-cat-info info-cat-training">加盟登録</div>
                  </div>
                  <div class="cmn-news-post">
                    <div class="cmn-news-date">2020/4/15</div>
                    <p class="cmn-news-name">
            ...
            <li class="cmn-news-item">
              <a href="#">
                <div class="cmn-news-article">
                  <div class="cmn-news-cat-wrapper">
                    <div class="cmn-news-cat-info info-cat-training">U-18</div>
                  </div>
                  <div class="cmn-news-post">
                    <div class="cmn-news-date">2020/4/15</div>
                    <p class="cmn-news-name">
