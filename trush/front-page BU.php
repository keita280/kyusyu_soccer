...
<main>
  <section class="mv">
    <div class="mv-inner">
      ...
      <figure class="twitter-news is-pc"></figure></a>
    </div>
  </section>
  ...
  <section class="top-tournament">
    <div class="top-tournament-inner inner wow fadeInUp">
      ...
      <div class="tournament-container">
        ...
        <a href="<?php echo esc_url(home_url()); ?>/category/info-cat-tournament/info-cat-u17/" class="tm-Btn  tm-btn-training">
          <span class="tm-Btn-Text1">九州クラブユース</span>
          <span class="tm-Btn-Text2">U-17</span>
          <span class="tm-Btn-Text3">大会</span>
        </a>
        <a href="<?php echo esc_url(home_url()); ?>/category/info-cat-tournament/info-cat-girls/" class="tm-Btn tm-btn-u17">
        <span class="tm-Btn-Text1">九州クラブユース</span>
          <span class="tm-Btn-Text2">U-18</span>
          <span class="tm-Btn-Text3">女子</span>
        </a>
        <a href="<?php echo esc_url(home_url()); ?>/category/info-cat-tournament/info-cat-u15/" class="tm-Btn tm-btn-u15">
          <span class="tm-Btn-Text1">九州クラブユース</span>
  ...
  <section class="top-introduction" id="top-introduction">
    ...
    <div class="top-team inner wow fadeInRight">
      <div class="top-team-l is-pc">
        ...
        <a href="<?php echo esc_url(home_url()); ?>/2019medal/1078/">
