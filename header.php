...
<head>
  ...
  <!-- favicon -->
  <link rel="icon" href="<?php echo get_template_directory_uri(); ?>/img/clubyouth_color.png">
  <!-- fontowsome -->
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-2Z803G05MM"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-2Z803G05MM');
</script>
      ...
      <div class="header_top inner">
        ...
        <h1>
          <a href="<?php echo esc_url(home_url()); ?>">
            <div class="header_top_pc-container">
              <img src="<?php echo get_template_directory_uri(); ?>/img/clubyouth_color.png" alt="ロゴ画像" class="logo-pc" />
              <p>九州クラブユースサッカー連盟</p>
            </div>
          </a>
        </h1>
