<div class="aside-inner">
          ...
          <ul class="aside-container">
            <li class="aside-li opacity"><a href="<?php echo esc_url(home_url()); ?>/news/">お知らせ一覧</a></li>
            <li class="aside-li">
              <a href="<?php echo esc_url(home_url()); ?>/category/info-cat-tournament/" class="opacity">大会情報一覧</a>
            ...
            <li class="aside-li opacity"><a href="<?php echo esc_url(home_url()); ?>/category/info-cat-confirm/">加盟登録一覧</a></li>
          </ul>
        </div>
        <?php get_search_form(); ?>
